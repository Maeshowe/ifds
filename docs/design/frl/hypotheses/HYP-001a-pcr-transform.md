...
# HYP-001A — PCR — transzform-szintű IC (az ÉLŐ flow-sub-score)
...
<VÁZ — a tartalmat Chat (Dev) tölti. Irány: Az élő pipeline PCR-transzformját méri (EWMA + küszöbök + sign együtt), nem a nyers PCR-jelet.>

> Párja: `HYP-001b-pcr-raw.md` — az a/b aszimmetria-szabály miatt KÜLÖN attempt-család.
