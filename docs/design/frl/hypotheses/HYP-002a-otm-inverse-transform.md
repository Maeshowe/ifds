...
# HYP-002A — OTM-inverse — transzform-szintű IC
...
<VÁZ — a tartalmat Chat (Dev) tölti. Irány: A második Bonferroni-szignifikáns legacy komponens élő transzformjának mérése.>

> Párja: `HYP-002b-otm-inverse-raw.md` — az a/b aszimmetria-szabály miatt KÜLÖN attempt-család.
